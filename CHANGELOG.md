...
- Support overridden annotations next to `$ref`, such as a different `description` value

### Changed

- Release binaries now include darwin/amd64, darwin/arm64, windows/amd64, and windows/arm64 alongside the existing linux targets. Windows binaries are named `schemadocs-windows-<arch>.exe`.

## [0.4.0] - 2026-03-03

### Fixed

- Fix markdownlint violations (MD036, MD026, MD019, MD024) in linear layout output
...
- Fix panic for number-typed values

## [0.3.0] - 2025-11-28

### Added

- Support `allOf`, `oneOf`, `const` and `enum`
- Fix rendering type as `[string]` when it's actually `string` (same for all types)
...
[Unreleased]: https://github.com/giantswarm/schemadocs/compare/v0.4.0...HEAD
[0.4.0]: https://github.com/giantswarm/schemadocs/compare/v0.3.2...v0.4.0
[0.3.2]: https://github.com/giantswarm/schemadocs/compare/v0.3.1...v0.3.2
[0.3.1]: https://github.com/giantswarm/schemadocs/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/giantswarm/schemadocs/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/giantswarm/schemadocs/compare/v0.1.0...v0.2.0
